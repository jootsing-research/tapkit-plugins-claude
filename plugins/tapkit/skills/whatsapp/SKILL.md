...
- Mask unsaved phone numbers in confirmations and model output, showing only enough digits to distinguish the intended recipient (for example, `+1 (***) ***-1234`). Keep the full number on-device and ask the user to review it there when needed.
